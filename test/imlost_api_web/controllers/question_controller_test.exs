defmodule ImlostApiWeb.QuestionControllerTest do
  use ImlostApiWeb.ConnCase

  alias ImlostApi.Classrooms

  @create_attrs %{content: "some content", upvotes: 42}
  @update_attrs %{content: "some updated content", upvotes: 43}
  @invalid_attrs %{content: nil, upvotes: nil}

  def fixture(:question) do
    {:ok, question} = Classrooms.create_question(@create_attrs)
    question
  end
